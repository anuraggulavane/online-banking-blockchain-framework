        ...
        <section class="content">
          <div class="row">
            ...
            <br></br>
              ...
              <div class="box box-solid bg-light-blue-gradient">
                <div class="box-header">
                 <h4 class="card-title"><h2><b>Sign In to the System</b></h2></h4>
                    ...
                    <tbody>
                      ...
                      <tr>
							...
							<td><select style="width: 180px; height: 30px"
								id="username" name="roll" style="color: #0000;" required="required">
								<option selected="selected" style="color: #0000;">------ Select Roll ------</option>
								<option value="User" font-color="black">User</option>
           ...
           <section class="col-lg-4 connectedSortable">
         	<div>
                <div>
                  <img src="images/Login1.png" alt="User Image" style="width: 270px; height:355px"/>
                </div>
              </div><br></br><br></br>
            </section></div> 
