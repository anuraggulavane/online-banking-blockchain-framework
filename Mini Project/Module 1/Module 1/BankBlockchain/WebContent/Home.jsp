...
<%
	...
	{
		out.println("<script>alert('User Profile Update Successfull...!')</script>");
	}
   %>
    <div class="wrapper">
        ...
        <section class="content">
          ...
          <br></br>
              ...
              <div>
               ...
               <table align="center">
					<tr>
						<td><img src="images/users.jpg" width="300" height="200">
					</tr>
					<tr>
						<td align="center"><span style="font-size:22px; color: red">Welcome to User Section</span></td>
					</tr>
					<tr>
						<td align="center"><h3><b>Welcome <%=session.getAttribute("Uusername")%></b></h3></td>
					</tr>
					<tr>
						<td align="center"><span style="font-size:22px; color: red">(by Best User/Customer)</span></td>
					</tr>
            	</table>
                  </div>
              </div>
           ...
           <section class="col-lg-8 connectedSortable">
         	<div>
                <div>
                  <img src="images/home.png" alt="User Image" style="width: 650px; height:450px"/>
                </div>
              </div><br></br><br></br>
            </section></div> 
