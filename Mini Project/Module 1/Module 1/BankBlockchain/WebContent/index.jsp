          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="index.jsp"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
               <li class="active treeview">
              <a href="LoginPage.jsp"><i class="glyphicon glyphicon-log-in"></i> <span>SignIn</span></a></li>
               <li class="active treeview">
          ...
          <div class="row">
            <section class="col-lg-12 connectedSortable">
              <div class="nav-tabs-custom">
              	<img src="images/Ride11.png" alt="User Image"/>
              </div>
            </section>
            ...
            <section class="col-lg-12 connectedSortable">
              <div class="box box-solid bg-light-blue-gradient">
                ...
                <img src="images/imgg.png" alt="User Image" style="width: 1070px;"/>
                </div>
              </div>
            </section>
          </div>
